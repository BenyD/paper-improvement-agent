...
- Semantic Scholar's unauthenticated pool rate-limits aggressively (HTTP 429). Affected entries stay honestly "unverified" with the real cause; an optional `SEMANTIC_SCHOLAR_API_KEY` removes most of these.
