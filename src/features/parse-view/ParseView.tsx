...
export function ParseView({ doc }: { doc: PaperDocument }) {
  return (
    <div className="mx-auto flex w-full max-w-3xl flex-col gap-8 px-6 py-10">
      ...
      {doc.abstract !== "" && (
        <section className="rounded-xl bg-neutral-50 p-5 dark:bg-neutral-900">
          ...
          {doc.sections.map((section) => (
            <li key={section.id}>
              <details className="group rounded-lg border border-neutral-200 dark:border-neutral-800">
                <summary
                  className="cursor-pointer select-none px-4 py-2.5 text-sm font-medium hover:bg-neutral-50 dark:hover:bg-neutral-900"
                  style={{
                ...
                <div className="flex flex-col gap-3 border-t border-neutral-100 px-4 py-3 dark:border-neutral-800">
